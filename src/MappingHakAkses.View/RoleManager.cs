...
namespace MappingHakAkses.View
{
   public class RoleManager
   {
      ...
      private readonly IRoleDetailController _roleDetailController;
      private readonly IFormActionController _formActionController;
      // Untuk trace tiap2 property di object FormAction
      private sbyte _colActNo = 0;
      ...
      public void ResetFormAction(Assembly assembly)
      {
         try
         {
            ...
            if (MenuStrip != null)
            {
               _formActionController.DeleteAll();
               _roleDetailController.DeleteAll();
      ...
      private void GetTypeFromAssembly(Assembly assembly)
      {
         ...
         var formTypes = assembly.GetTypes().Where(t => t.IsClass && t.BaseType.Name.Contains("Form")
      ...
      private void PopulateButtonFormToFormAction(Form form)
      {
         ...
         _formActionController.Save(formAction);
      }
      ...
      public List<KeyValuePair<object, string>> DataSourceMenuParent()
      {
         if (MenuStrip == null)
         {
            throw new NullReferenceException("Anda tidak mempunyai MenuStrip untuk dimapping ke ComboBox");
         }
      ...
      public void PopulateMenuStripToTreeView(string menuParent)
      {
         ...
         var listFormAction = _formActionController.GetAll().ToList();
      ...
      /// </summary>
      /// <param name="listFormAction">Data FormAction</param>
      /// <param name="treeNode">Node parent</param>
      /// <param name="toolStripMenuItem">Menu item parent</param>
      private void AddMenuToTree(List<FormAction> listFormAction, TreeNode treeNode
            ...
            foreach (var item in toolStripMenuItem.DropDownItems)
            {
               ...
               if (!string.IsNullOrWhiteSpace(menuItem.AccessibleName))
               {
                  ...
                  if (accsName.Equals("menuForm")) // Menu yang memanggil Form
                  {
                     ...
                     if (formAction != null)
                     {
                        // Looping setiap property di object FormAction
      ...
      public void PopulateRoleDetailToTreeView(string roleKode, string menuParent)
      {
         ...
         var listRoleDetail = _roleDetailController.GetByMenuParent(roleKode, menuParent).ToList();
      ...
      /// <param name="nodes">TreeNodeCollection TreeView</param>
      private void PopulateItemChecked(List<RoleDetail> listRoleDetail, TreeNodeCollection nodes)
      {
      ...
      public int UpdateRole(string roleKode, string menuParent)
      {
         ...
         _roleDetailController.Delete(roleDetail);

         List<RoleDetail> listRoleDetail = new List<RoleDetail>();

         // isi data role detail sesuai node yang di check
         InsertItemChecked(listRoleDetail, roleKode, menuParent, TreeView.Nodes);

         return _roleDetailController.Save(listRoleDetail);
      }
      ...
      public void PopulateRoleDetailToMenuStripAndToolStrip()
      {
         ...
         var listRoleDetail = _roleDetailController.GetAllByRoleKode(RoleKode).ToList();
      ...
      private void EnableMenuStripItem(List<RoleDetail> listRoleDetail, ToolStripItemCollection items)
      {
      ...
      private void EnableToolStripItem(List<RoleDetail> listRoleDetail, ToolStrip toolStrip)
      {
         foreach (var item in toolStrip.Items)
         {
            if (item is ToolStripButton)
      ...
      private void EnableToolStripMenuItem(List<RoleDetail> listRoleDetail, ToolStripItemCollection items)
      {
      ...
      public void EnableButtons(Control form)
      {
         ...
         var actionButtons = _roleDetailController.GetAllMenuNameByTagAction(RoleKode, form.Name).ToList();
